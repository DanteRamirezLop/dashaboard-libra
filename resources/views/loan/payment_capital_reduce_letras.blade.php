<div class="modal-dialog" role="document">
  <div class="modal-content">
    {{ Form::open(['route' => ['pay.capital.reduce.letras'], 'id' => 'transaction_payment_add_form']) }}
    {!! Form::hidden('loan_id', $loan->id); !!}
    {!! Form::hidden('transaction_id', $transaction->id); !!}
    {!! Form::hidden('type_pay', $type); !!}
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">@lang( 'purchase.add_payment' ) capital <small class="text-muted">(reduce letras)</small></h4>
    </div>
    <div class="modal-body">
     ...
     <div class="row">
      ...
      <div class="alert alert-info">
        ...
        <strong>Modo: reducir letras.</strong> La cuota mensual se mantiene igual y se eliminan las letras finales del calendario.
        <br>Monto mínimo para reducir al menos 1 letra: <strong class="text-success">$ {{ $minCapital_formated }}</strong>
      </div>
         ...
         <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                {!! Form::text("amount", @num_format($minCapital), ['class' => 'form-control input_number payment_amount','required', 'placeholder' => 'Amount', 'data-rule-max-value' => @num_format($amount), 'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' => $amount_formated])]); !!}
              </div>
            </div>
          </div>
        <div class="col-md-12">
