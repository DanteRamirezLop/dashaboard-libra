     ...
     <div class="row payment_row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control currency_change_dropdown" name="currency" id="currency">
        ...
        <div class="col-md-12 hide" id="calculate_dollars">
          <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  {!! Form::label('exchange_rate', 'Tipo de cambio Dolar' . ':*') !!} 
                  <div class="input-group">
                      <span class="input-group-addon">
                        <i class="fas fa-money-bill-alt"></i>
                      </span>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  {!! Form::label("amount_var" , 'Total en soles'. ':*') !!}
                  <div class="input-group">
                    <span class="input-group-addon">
                      <i class="fas fa-money-bill-alt"></i>
                    </span>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <button type="button" class="btn btn-primary" id="calculate_sol">Calcular Soles </button>
                  </div>
                </div>
              </div>
            </div>
         ...
         <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                {!! Form::text("amount", @num_format($amount), ['class' => 'form-control input_number payment_amount','required','readonly', 'placeholder' => 'Amount', 'data-rule-max-value' => @num_format($amount), 'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' => $amount_formated])]); !!}
              </div>
            </div>
          </div>
        <div class="col-md-12">
