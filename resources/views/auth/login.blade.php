        ...
        <div class="col-md-4">
            <div class="tw-p-5 md:tw-p-6 tw-mb-4 tw-rounded-2xl tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm tw-ring-1 tw-ring-gray-200">
                <div class="tw-flex tw-flex-col tw-gap-4 tw-dw-rounded-box tw-dw-p-6 tw-dw-max-w-md">
                    <div class="tw-dw-card">
                        <figure>
                             <img src="{{ asset('img/logo-small.png')}}" alt="lock" class="tw-h-12 " />
                        </figure>
                    </div>
            ...
            <div class="tw-text-center tw-text-xs md:tw-text-sm text-white">
               Designed by <a href="https://onfleekmedia.com" target="_blank" class="tw-font-medium hover:tw-underline">Onfleek Media</a> | V6.8.1
            </div>
        </div>
