		        ...
		        @if(!empty($custom_field_2_label))
		        	...
		        	<div class="col-md-4">
				        <div class="form-group">
				            ...
				            {!! Form::select('custom_field_2', $fuente_contacto_options, null, ['class' => 'form-control select2', 'required' => $is_custom_field_2_required]); !!}
				        </div>
				    </div>
		        @endif
		        @if(!empty($custom_field_3_label))
		        	...
		        	<div class="col-md-4">
				        <div class="form-group">
				            ...
				            {!! Form::select('custom_field_3', $credito_tercero_options, null, ['class' => 'form-control select2', 'required' => $is_custom_field_3_required]); !!}
				        </div>
				    </div>
		        @endif
		        @if(!empty($custom_field_4_label))
		        	...
		        	<div class="col-md-4">
				        <div class="form-group">
				            ...
				            {!! Form::select('custom_field_4', $credito_contado_options, null, ['class' => 'form-control select2', 'required' => $is_custom_field_4_required]); !!}
				        </div>
				    </div>
		        @endif
